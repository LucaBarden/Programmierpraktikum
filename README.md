...
* [Spring Web](https://docs.spring.io/spring-boot/docs/2.6.4/reference/htmlsingle/#boot-features-developing-de.propra.chicken.adapter.web-applications)
...
* [Serving Web Content with Spring MVC](https://spring.io/guides/gs/serving-de.propra.chicken.adapter.web-content/)
* [Building REST services with Spring](https://spring.io/guides/tutorials/bookmarks/)
* [Handling Form Submission](https://spring.io/guides/gs/handling-form-submission/)
* [Securing a Web Application](https://spring.io/guides/gs/securing-de.propra.chicken.adapter.web/)
