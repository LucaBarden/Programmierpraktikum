...
public class StudentServiceTests {
    ...
    public void test1() {
        LocalDate tag = LocalDate.now(clock).plusDays(2);
    ...
    public void test3() {
        Student student = new Student(123456);
        Klausur klausur = new Klausur("RA", 44445, false, LocalDate.now(clock).toString(), LocalTime.of(10,0,0).toString(), LocalTime.of(11,30,0).toString());
    ...
    void urlaubsvalidierung1() {
        ...
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "08:30", "12:30");
    ...
    void urlaubsvalidierung2() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(1).toString(), "08:00", "09:00");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung3() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(1).toString(), "10:00", "09:00");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung21() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).minusDays(9).toString(), "08:30", "09:00");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung22() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.parse(ENDDATUM).plusDays(1).toString(), "08:30", "09:00");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung4() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "10:00", "10:00");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung5() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "10:53", "12:00");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung6() {
        ...
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "10:00", "10:30");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung7() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "08:30", "11:30");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung8() {
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
        Urlaub urlaub = new Urlaub(LocalDate.now(clock).toString(), "08:30", "11:30");
        Set<KlausurData> klausuren = new HashSet<>();
    ...
    void urlaubsvalidierung9() {
        String tag = LocalDate.now(clock).plusDays(2).toString();
        StudentService studentService = new StudentService(clock);
        Student student = new Student(123);
    ...
    void urlaubsvalidierung15() {
        ...
        Urlaub urlaub1 = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "08:30", "09:30");
        Urlaub urlaub2 = new Urlaub(LocalDate.now(clock).plusDays(2).toString(), "11:00", "12:30");
    ...
    void stornierbareUrlaube() {
        String heute = LocalDate.now(clock).toString();
        String gestern = LocalDate.now(clock).minusDays(1).toString();
        String morgen = LocalDate.now(clock).plusDays(1).toString();
        String naechsteWoche = LocalDate.now(clock).plusDays(7).toString();
        StudentService studentService = new StudentService(clock);
        Set<Urlaub> urlaube = new HashSet<>();
