...
import de.propra.chicken.db.KlausurRepositoryImpl;
...
public class KlausurServiceTest {
    ...
    @Test
    @DisplayName("Testet ob eine ugültige LSF ID einen Fehler wirft")
    public void validLSFID(){
        ...
        assertThrows(Exception.class, () -> {
            service.save(new Klausur("Test", 219960, false, null, null, null));
        });
    }
